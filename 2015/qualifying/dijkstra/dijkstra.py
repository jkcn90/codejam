...
def get_lesser_number_of_times_to_repeat(number_of_times_to_repeat):
    if number_of_times_to_repeat >= 12:
        number_of_times_to_repeat = 4 + 4 + number_of_times_to_repeat % 4
    return  number_of_times_to_repeat
...
def process_instance(instance):
    ...
    number_of_times_to_repeat = get_lesser_number_of_times_to_repeat(
